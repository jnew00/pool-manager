...
export const TEAM_DIVISIONS: Record<
  string,
  { division: string; divisionInfo: DivisionInfo }
> = {}
 ...
 */
export function areTeamsDivisionRivals(
  homeTeamAbbr: string,
  awayTeamAbbr: string
): boolean {
 ...
 */
export function areTeamsSameConference(
  homeTeamAbbr: string,
  awayTeamAbbr: string
): boolean {
  const homeDiv = TEAM_DIVISIONS[homeTeamAbbr]
 ...
 */
export function getRivalryIntensity(
  homeTeamAbbr: string,
  awayTeamAbbr: string
): number {
