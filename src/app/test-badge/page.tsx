  ...
  const mockProjection = {
    ...
    factors: {
      ...
      newsAnalysis: {
        ...
        summary: 'Key factors: Test quarterback injury affecting team performance',
        adjustment: 2.0
      }
    },
    modelVersion: '1.0.0',
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-4 p-4 bg-yellow-100 rounded">
        <p><strong>Expected:</strong> Should see a blue "News" badge with hover tooltip</p>
        <p><strong>newsAnalysis data:</strong></p>
        <pre className="text-sm mt-2">{JSON.stringify(mockProjection.factors.newsAnalysis, null, 2)}</pre>
      </div>
