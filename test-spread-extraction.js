...
console.log('\nThis should extract:')
console.log('- WAS vs NYG, spread_for_home: +3.5 (Giants home, Commanders favored)')
console.log('- TEN vs HOU, spread_for_home: -7 (Houston home, Titans getting points)')  
console.log('- CLE vs DAL, spread_for_home: +6 (Cowboys home, Browns favored)')
console.log('- GB vs LAR, spread_for_home: -2.5 (Rams home, Packers getting points)')
